  ...
  const reelItems: ExtendedPostItem[] = combined.map((m, index) => {
    ...
    return {
      ...
      insights: {
        ...
        watchTime: "0m",
        avgWatchTime: "0s",
        followerViewsPct: [42, 38, 55, 48, 35, 60, 45, 50, 40, 52, 36, 58, 44, 39, 47, 53, 41, 56, 43, 49][idx % 20] || 45,
        viewRatePast3Sec: 0,
        genderMale: [62, 55, 70, 58, 48, 65, 52, 60, 50, 67, 54, 72, 56, 49, 63, 59, 51, 68, 53, 61][idx % 20] || 58,
        genderFemale: 100 - ([62, 55, 70, 58, 48, 65, 52, 60, 50, 67, 54, 72, 56, 49, 63, 59, 51, 68, 53, 61][idx % 20] || 58),
        countries: [],
        ageGroups: [],
        sources: [],
