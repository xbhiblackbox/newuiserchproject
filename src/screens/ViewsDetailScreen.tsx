...
const defaultData: ViewsData = {
  ...
  accountsReachedChange: "+210,938,600%",
  ...
  profileActivityTotal: 9297,
  profileActivityChange: "+61,880.0%",
  profileActivityCompare: "vs Mar 6 - Apr 4",
  profileVisits: 9297,
  profileVisitsChange: "+61,880.0%",
  linkTaps: 0,
  linkTapsChange: "--",
};
