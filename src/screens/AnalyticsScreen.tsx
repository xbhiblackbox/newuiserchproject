...
const AnalyticsScreen = () => {
  ...
  const toolItems = [
    ...
    { label: "Partnership ads", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="7" r="3"/><path d="M3 20v-1c0-3.31 2.69-6 6-6"/><circle cx="17" cy="8.5" r="2.5"/><path d="M21 20v-1c0-2.76-2.24-5-5-5"/></svg> },
    { label: "Ad tools", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="4 18 8 13 12 15 16 8 20 12"/><polyline points="16 8 20 8 20 12"/></svg> },
    { label: "Trial reels", icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="5" width="18" height="14" rx="3"/><circle cx="7" cy="8" r="1.5"/><circle cx="17" cy="8" r="1.5"/><polygon points="10,10 10,16 15,13" fill="currentColor" stroke="none"/></svg>, badge: "New" },
